...
//        dataSource.setPassword("");
        ...
        //todo fix contstructor to take db params
...
//            System.out.println(statement.toString());
    ...
    public void addToWaitlist(int workoutId, int userId) {
        System.out.println("database.Database addToWaitlist method started");
        Connection connection = null;
    ...
    public void quitWaitlist(int waitlistId) {
        System.out.println("database.Database quitWaitlist method started");
        Connection connection = null;
    ...
    public ArrayList<WaitlistItem> getMyWaitlist(int userId) {
        System.out.println("database.Database getMyWaitlist method started");
    ...
    public List<LogDataEntry> getOperationLog(int userId) {
        ...
        List<LogDataEntry> logList = new ArrayList<>();
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            ResultSet resultSet = statement.executeQuery();
            while (resultSet.next()) {
                LogDataEntry logEntry= new LogDataEntry();
                logEntry.setOperationDateTime(resultSet.getLong("operation_date_time"));
                logEntry.setBalanceChange(resultSet.getInt("balance_change"));
                logEntry.setOperationInfo(resultSet.getString("operation_info"));
                logEntry.setReferenceName(resultSet.getString("first_name"));
                logEntry.setReferenceFamilyName(resultSet.getString("family_name"));
